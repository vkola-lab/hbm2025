...
def init_distributed_mode(args):
    ...
    ic('RANK' in os.environ and 'WORLD_SIZE' in os.environ)
    ic('SLURM_PROCID' in os.environ)
    ic(torch.cuda.is_available())
    ic(os.environ["MASTER_PORT"])
    ...
    ic(args.dist_url)
    ic(args.gpu, args.world_size, args.rank)
    ...
    ic(os.environ.get('CUDA_VISIBLE_DEVICES', []))
    # os.environ['CUDA_VISIBLE_DEVICES'] = 
    args.rank = args.gpu
    ic(args.rank, args.world_size, args.gpu)
